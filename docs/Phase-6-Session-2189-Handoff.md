# Phase 6 Session 2189 Handoff - FindGroup Mutation Projected Row Comparison Result Skeleton
...
- `Aion.GameServer.Services.FindGroupMutationPostProjectedRowComparisonResultSkeleton`
- `Aion.GameServer.Services.FindGroupMutationPostProjectedRowComparisonResultSkeletonRow`
- `Aion.GameServer.Tests.FindGroupMutationPostProjectedRowComparisonResultSkeletonServiceTests`

## Validation In UOW-2189
...
```text
[Phase 6][UOW-2189] Add find group mutation comparison result skeleton
```
