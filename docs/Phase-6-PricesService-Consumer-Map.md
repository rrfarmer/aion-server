...
1. Add a pure bind-point teleport distance-price planner from `BindPointTeleportService.calculateTeleportationPrice`.
2. Keep teleport price planners non-live until movement routing, packet order, and persistence are ready.
