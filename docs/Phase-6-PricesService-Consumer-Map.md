...
1. Audit paid teleport price deduction before touching live teleport handler paths.
2. Keep `SM_SELL_ITEM` non-live until dialog routing, runtime trade-list facts, and packet-order behavior are ready.
