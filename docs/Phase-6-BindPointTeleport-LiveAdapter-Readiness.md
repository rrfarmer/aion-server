...
| Inventory mutation | `tryDecreaseKinah(price, DEC_KINAH_FLY)` with persistence and packet order | Non-live mutation planner added in UOW-1225; callback metadata composition added in UOW-1226; runtime non-sending metadata carry-through added in UOW-1227; UOW-1222 audit completed; UOW-1223 packet mask coverage added; UOW-1224 owner design completed | Isolate live persistence/send and owner/lock before dispatch. |
