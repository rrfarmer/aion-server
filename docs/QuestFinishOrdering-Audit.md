...
1. Stage reward/work-item descriptors and reward-group correction before enabling any live quest-finish path.
...
- Reward calculation and inventory mutation ordering are source-audited but not ported.
