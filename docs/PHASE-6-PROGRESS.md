...
- Next implementation slice should continue housing auction end/prolongation/sign/appearance flows, full known-list fanout/movement broadcast, broader chat packet surfaces, or equipment stat application once item templates/stat functions are in scope.
- Latest validation: `dotnet test dotnetConversion\AionServer.slnx` passed with 290 tests.
...
1. Continue housing auction end/prolongation/sign/appearance flows, full known-list fanout, or the next high-value chat/group packet surface.
