...
1. Tighten the new decomposition/item-add path with Java special-cube capacity checks (`extraInventoryId`) and richer partial-add failure behavior, then reuse the planner for future reward/remodel flows.
