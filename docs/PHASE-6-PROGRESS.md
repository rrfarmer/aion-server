...
2. Continue `CM_MANASTONE` beyond the immediate first-pass branches: delayed use animations, movement/cancel observer cleanup, item cooldown abort cleanup, enchant +20 buff-skill changes, and richer NPC known-list/range validation.
