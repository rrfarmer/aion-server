...
- Next implementation slice should continue full known-list fanout/movement broadcast, housing auction/bid flows, trading-state guards, or equipment stat application once item templates/stat functions are in scope.
...
1. Continue full known-list fanout, housing auction/bid flows, or trading-state guards.
