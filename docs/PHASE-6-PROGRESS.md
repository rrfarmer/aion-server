...
2. Finish the remaining stigma membership/login slices: `STIGMA_AUTOLEARN` login-time temporary skill learning, exact hidden-stigma delete messages, and full SkillEngine effect application after temporary skill mutations.
