...
1. Finish full `CM_EQUIP_ITEM` parity beyond the current mutation and guard path: linked stigma unlocks, stigma enchant/charge-stone flow, exact soul-bind timing/cancel/stance behavior, power-shard emotion side effects, quest/summon observers, and exact speed/emotion fanout.
