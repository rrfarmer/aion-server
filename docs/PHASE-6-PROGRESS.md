...
- Next implementation slice should continue full known-list fanout/movement broadcast, housing auction/bid flows, broker AdminService-style restriction checks, or equipment stat application once item templates/stat functions are in scope.
...
1. Continue full known-list fanout, housing auction/bid flows, or broker AdminService/restriction checks.
