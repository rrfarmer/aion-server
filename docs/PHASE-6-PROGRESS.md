...
2. Continue `CM_MANASTONE` beyond stigma charge/removal/godstone/amplification/manastone foundations: Java supplement validation/count consumption/chance math for action `2`, enchant-stone action `1` success/failure, delayed use animations, and abort cleanup.
