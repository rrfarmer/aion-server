...
Next recommended unit of work:
- Add a staged shared-damage/finalization surface for Java `EffectTemplate.isShared`, `Skill.getEffectedList().size`, final minimum-damage floor, and final effected-NPC AI damage hook ordering in `AttackUtil.calculateSkillResult`.
