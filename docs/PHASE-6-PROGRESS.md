...
- Next implementation slice should continue deeper equipment stat effects such as conditioning/idian/godstone effects, housing auction settlement/maintenance/sign/appearance flows, full known-list fanout/movement broadcast, or broader chat packet surfaces.
...
1. Deepen equipment/item stat parity from the Java source: conditioning, idian/godstone effects, armor mastery, and the eventual `CreatureGameStats`/`Stat2` container.
