...
1. Broaden reusable item-add planner reuse in the next reward/item service that creates inventory rows outside the current decompose, assembly, and XP extraction paths.
