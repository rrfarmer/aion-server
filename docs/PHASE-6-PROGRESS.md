...
1. Tighten the reusable item-add planner with template-aware special-slot capacity for non-overflow callers and richer Java partial-add failure behavior, then reuse it for future reward/remodel flows.
