...
1. Continue item-action routing with another bounded Java action such as decomposition, after checking persistence and packet fanout; keep remodel behind NPC/dialog validation unless that support is expanded first.
