...
4. Continue `CM_EMOTION` / `CM_MOVE` flight work by adding one missing support model at a time: live fly/no-fly zone membership, full audit-system staff/punishment fanout, FP timers, stance observers, sit observers, quest/summon observers, or deeper reusable stat-speed calculation.
