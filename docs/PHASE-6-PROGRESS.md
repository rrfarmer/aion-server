...
1. Wire Java `TaskId.ITEM_USE` delayed execution onto the new one-shot scheduler for `CM_MANASTONE` action `2`, including movement cancel observer cleanup and Java cancel/end `SM_ITEM_USAGE_ANIMATION` behavior.
