...
- Latest validation: `dotnet test dotnetConversion\AionServer.slnx` passed with 289 tests.
...
1. Continue friend add/question-window flow, full known-list fanout, or housing auction/bid persistence.
