...
1. Continue tightening reusable item-add behavior with richer Java partial-add caller messaging, then reuse it for future reward/remodel/assembly flows.
