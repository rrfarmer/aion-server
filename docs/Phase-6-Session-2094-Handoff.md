# Phase 6 Session 2094 Handoff - Find Group Show List Direct Evidence
...
- Parsed action 0 recruitment show-list direct packet evidence now exists.
- Parsed action 4 application show-list direct packet evidence now exists.
...
- Current UOW commit message: `[Phase 6][UOW-2094] Add find group show list direct evidence`
...
- Parsed action 10/13 instance-group show-list direct packet evidence has not been added yet.
...
- Broad .NET suite/build was not run in UOW-2094 because no broad-validation trigger applied.
