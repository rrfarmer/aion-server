...
2. Predicate coverage
   ...
   - Current unsupported categories include production static-data loading, configurable master-crafting adjustment, NPC faction repository/static-data hydration, and quest-finish repeat-date calculation.
