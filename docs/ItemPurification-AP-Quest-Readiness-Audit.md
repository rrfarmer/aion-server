...
- Continue toward XML start-condition data/predicate support or broader refresh-plan audits before any player-controller refresh adapter; keep it disconnected from production ItemPurification dispatch before invoking any live quest handlers.
