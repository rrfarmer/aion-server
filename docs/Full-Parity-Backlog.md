...
- reads `con.getActivePlayer()`: `SM_PRICES`, `SM_PLAY_MOVIE`, `SM_DIALOG_WINDOW`, `SM_FRIEND_UPDATE`, `SM_CHALLENGE_LIST`, `SM_GROUP_INFO` **[AUDITED 1:1 2026-06-17]**, `SM_ALLIANCE_INFO` **[AUDITED 1:1 2026-06-17]**, `SM_HOUSE_OBJECT`, `SM_HOUSE_REGISTRY`, `SM_HOUSE_BIDS`, `SM_HOUSE_EDIT`, `SM_INSTANCE_INFO`, `SM_SIEGE_LOCATION_INFO`.
