...
- live `SiegeService`/`Influence`/`GameTimeService`/`TownService`/`GameServer`/`LoginServer` singleton or `System.currentTimeMillis`/JVM-uptime: `SM_GAME_TIME`, `SM_TIME_CHECK`, `SM_VERSION_CHECK`, `SM_INFLUENCE_RATIO` **[AUDITED 1:1 2026-06-17 batch 14]** (live Influence+SiegeService), `SM_FORTRESS_STATUS` **[AUDITED 1:1 2026-06-17 batch 14]** (live SiegeService.getFortresses()+Influence), `SM_LEGION_DOMINION_LOC_INFO` **[AUDITED 1:1 2026-06-17 batch 14]** (live LegionDominionService+LegionService+legion/emblem graph), `SM_IN_GAME_SHOP_CATEGORY_LIST`, `SM_IN_GAME_SHOP_ITEM`, `SM_IN_GAME_SHOP_LIST`, `SM_ITEM_COOLDOWN`, `SM_RECIPE_COOLDOWN`.
