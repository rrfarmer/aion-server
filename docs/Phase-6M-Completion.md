...
- Kept `docs/PHASE-6-PROGRESS.md` current through Session 178.
...
- Broader `CM_EMOTION` behavior still needs abnormal-state/stance guards, full fly/land eligibility/cooldown/FP/stat-controller behavior, fly-teleport/sprint controller behavior, sit observers, quest/summon observers, and exact movement/attack speed fanout.
