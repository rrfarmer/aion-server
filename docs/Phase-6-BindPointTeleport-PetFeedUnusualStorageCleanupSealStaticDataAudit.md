...
4. Extend packet call sites to pass the explicit flag when a dataholder is available.
5. Add a focused `SmInventoryInfo` general-info blob test for item id `188053996` expecting cleanup/seal field `3`.
