...
1. Add a disabled-by-default quest-finish runtime input assembler that refuses enabled custom reward execution when account creation time, item templates, or object-id allocation are missing.
