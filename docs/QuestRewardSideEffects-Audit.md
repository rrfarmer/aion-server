...
1. Compose static default regular non-item reward projection with the existing guard/operation planners in a non-live regression, or extend the extractor to regular item/selectable reward lists.
