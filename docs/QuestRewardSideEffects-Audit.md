...
1. Preserve login-server account creation time on active C# account/session state without enabling custom reward execution, or add a session-shaped guard adapter around `QuestFinishCustomRewardRuntimeInputAssemblerService`.
