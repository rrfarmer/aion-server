...
1. Bridge `SystemMailRewardPersistencePlanService` into an explicit disabled-by-default system-mail execution adapter, or add a disabled-by-default runtime adapter that gathers custom reward execution inputs for XP level-change composition.
