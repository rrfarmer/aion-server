...
1. Add a static-data projection prerequisite for Java `QuestTemplate.can_report` and reward metadata, or compose the new non-live dialog auto-reward guard intent with explicit mock quest-finish projections.
