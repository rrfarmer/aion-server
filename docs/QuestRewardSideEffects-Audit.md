...
1. Add a non-live `CM_DIALOG_SELECT` self auto-reward guard planner or test helper that recognizes Java's reportable auto-reward branch and returns a disabled quest-finish planning intent.
