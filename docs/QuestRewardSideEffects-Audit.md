...
1. Add opt-in integration coverage for the system-mail repository executor, or add a disabled-by-default runtime adapter that gathers custom reward execution inputs for XP level-change composition.
