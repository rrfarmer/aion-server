...
1. Add a non-live composition test or helper that feeds session-assembled disabled options into `QuestFinishCustomRewardRuntimeSideEffectAdapterService` and confirms quest-finish XP metadata remains disabled by default.
