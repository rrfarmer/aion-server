...
1. Add disabled-by-default composition that can feed `QuestXpCustomRewardRuntimeInputAdapterService` output into quest-finish XP level-change input, or run the opt-in system-mail DB integration suite against a live MySQL schema when available.
