...
1. Add a narrow adapter from `NearbyQuestTemplateSummary` into dialog guard/planner prerequisite metadata, then begin full `QuestFinishRewardTemplateProjection` extraction from Java static quest rewards.
