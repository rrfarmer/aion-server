...
1. Begin full `QuestFinishRewardTemplateProjection` extraction from Java static quest rewards, starting with non-item reward fields only and keeping operation-planner composition non-live.
