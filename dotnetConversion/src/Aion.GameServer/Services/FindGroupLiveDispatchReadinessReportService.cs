	...
	public static FindGroupLiveDispatchReadinessReport CreateReport()
	{
		...
		return new FindGroupLiveDispatchReadinessReport(
			...
			[
				...
				"FindGroupWorldBroadcastFanoutReadinessService separates Java PacketSendUtility.broadcastToWorld race-filter review and C# opt-in registry fanout evidence from the still-missing live CM_FIND_GROUP actions 1/5 fanout proof.",
