	...
	public static FindGroupLiveDispatchReadinessReport CreateReport()
	{
		...
		return new FindGroupLiveDispatchReadinessReport(
			...
			[
				...
				"FindGroupDirectPacketBoundaryTraceReadinessService records action 0/4/8/11/15 disabled-boundary acceptance before opt-in registry execution of the direct SmFindGroup packet while keeping live ProcessPacketAsync ordering blocked.",
