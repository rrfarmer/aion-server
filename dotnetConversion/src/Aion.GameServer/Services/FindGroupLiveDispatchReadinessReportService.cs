	...
	public static FindGroupLiveDispatchReadinessReport CreateReport()
	{
		...
		return new FindGroupLiveDispatchReadinessReport(
			...
			[
				...
				"FindGroupConnectionBoundarySideEffectCompositionEvidenceService can compose parsed CmFindGroup planner output, including action 1 and action 5 world-broadcast intents, with opt-in executor results without wiring GameServerConnection.",
			],
