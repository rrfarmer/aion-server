	...
	public static FindGroupLiveDispatchReadinessReport CreateReport()
	{
		...
		return new FindGroupLiveDispatchReadinessReport(
			...
			[
				...
				"Action 11 instance application direct packet dispatch has connection-adjacent disabled executor evidence but is not invoked from the CM_FIND_GROUP boundary.",
			...
			[
				...
				"FindGroupInstanceApplicationDirectDispatchPlanService can compose action 11 direct SM_FIND_GROUP applicant packet dispatch evidence without sending packets.",
