		...
		return new FindGroupDirectPacketBoundaryTraceReadinessReport(
			...
			[
				...
				new FindGroupDirectPacketBoundaryTraceEvidence(
					...
					FindGroupDirectPacketBoundaryTraceEvidenceStatus.EvidenceAvailable),
				new FindGroupDirectPacketBoundaryTraceEvidence(
					FindGroupDirectPacketBoundaryTraceEvidenceKind.CSharpShowListLiveBoundaryTraceScaffold,
					"C# FindGroupDirectPacketShowListLiveBoundaryTraceScaffoldService scopes the first direct-packet live-boundary trace scaffold to Java show-list actions 0 and 4 without wiring ProcessPacketAsync or invoking live sends.",
					FindGroupDirectPacketBoundaryTraceEvidenceStatus.EvidenceAvailable),
				new FindGroupDirectPacketBoundaryTraceEvidence(
					FindGroupDirectPacketBoundaryTraceEvidenceKind.CSharpShowListTraceSchema,
					...
					FindGroupDirectPacketBoundaryTraceEvidenceStatus.EvidenceAvailable),
				new FindGroupDirectPacketBoundaryTraceEvidence(
					FindGroupDirectPacketBoundaryTraceEvidenceKind.CSharpShowListTraceExportProjection,
					"C# FindGroupDirectPacketShowListBoundaryTraceSchemaService can project schema version 1 C# exports from disabled action 0 and 4 boundary plans without invoking the executor or observing registry sends.",
					FindGroupDirectPacketBoundaryTraceEvidenceStatus.EvidenceAvailable),
				new FindGroupDirectPacketBoundaryTraceEvidence(
				...
				new FindGroupDirectPacketBoundaryTraceEvidence(
					...
					"C# FindGroupDirectPacketMutationPostBoundaryTraceSchemaService defines schema version 1 for future Java/C# action 2 and 6 mutation-post boundary trace exports without capturing live traffic.",
					FindGroupDirectPacketBoundaryTraceEvidenceStatus.EvidenceAvailable),
				new FindGroupDirectPacketBoundaryTraceEvidence(
					FindGroupDirectPacketBoundaryTraceEvidenceKind.CSharpMutationPostTraceExportProjection,
					"C# FindGroupDirectPacketMutationPostBoundaryTraceSchemaService can project schema version 1 C# exports from disabled action 2 and 6 boundary plans without invoking the executor or observing registry sends.",
					FindGroupDirectPacketBoundaryTraceEvidenceStatus.EvidenceAvailable),
				new FindGroupDirectPacketBoundaryTraceEvidence(
...
public enum FindGroupDirectPacketBoundaryTraceEvidenceKind
{
	...
	CSharpShowListTraceExportProjection,
	CSharpMutationPostLiveBoundaryTraceScaffold,
	CSharpMutationPostTraceSchema,
	CSharpMutationPostTraceExportProjection,
