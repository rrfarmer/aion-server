...
public static class PlayerTeleportService
{
	...
	public static PlayerTeleportResult TeleportToWorldPosition(Player player, WorldPosition destination)
	{
		// Java parity: services/teleport/TeleportService.teleportTo(Player, WorldPosition).
		var previousPosition = player.Position;
		player.Position = destination;
