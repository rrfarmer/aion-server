...
{
	public const string JavaApExtractActionSource =
		"game-server/src/com/aionemu/gameserver/model/templates/item/actions/ApExtractAction.java";

	public const string JavaAbyssPointsServiceSource =
	...
	public const string CSharpPlannerSource =
		"dotnetConversion/src/Aion.GameServer/Services/ApExtractService.cs#CreateMutationPlan";
...
public sealed record ApExtractionLiveMutationBoundaryStep(
	ApExtractionLiveMutationBoundaryStepKind Kind,
	string Description);
