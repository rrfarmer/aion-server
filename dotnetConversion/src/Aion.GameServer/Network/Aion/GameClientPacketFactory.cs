...
public static class GameClientPacketFactory
{
	...
	static GameClientPacketFactory()
	{
		...
		Register(0, states => new CmVersionCheck(0, states), GameConnectionState.Connected);
		Register(2, states => new CmDisconnect(2, states), GameConnectionState.Authed, GameConnectionState.InGame);
		...
		Register(35, states => new CmRemoveAlteredState(35, states), GameConnectionState.InGame);
		...
		Register(51, states => new CmBuyItem(51, states), GameConnectionState.InGame);
		...
		Register(70, states => new CmWindstream(70, states), GameConnectionState.InGame);
		...
		Register(77, states => new CmFindGroup(77, states), GameConnectionState.InGame);
		...
		Register(100, states => new CmViewPlayerDetails(100, states), GameConnectionState.InGame);
		Register(103, states => new CmPingRequest(103, states), GameConnectionState.InGame);
		Register(104, states => new CmGameguard(104, states), GameConnectionState.InGame, GameConnectionState.Authed);
		Register(107, states => new CmClientCommandRoll(107, states), GameConnectionState.InGame);
		Register(108, states => new CmGroupDistribution(108, states), GameConnectionState.InGame);
		...
		Register(118, states => new CmAbyssRankingLegions(118, states), GameConnectionState.InGame);
		...
		Register(121, states => new CmSummonCommand(121, states), GameConnectionState.InGame);
		...
		Register(200, states => new CmAutoGroup(200, states), GameConnectionState.InGame);
		...
		Register(207, states => new CmBreakWeapons(207, states), GameConnectionState.InGame);
