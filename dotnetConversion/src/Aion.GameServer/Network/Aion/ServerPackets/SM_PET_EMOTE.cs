...
// Java parity (writeImpl audited 1:1 vs game-server/.../SM_PET_EMOTE.java): 2026-06-17 — reads live Pet/MoveController graph; PetEmote enum value==Java emoteId so (int)emote==getEmoteId() (T2 audit-only).
