...
/// <summary>Java parity: configs/main/AutoGroupConfig (xTz). @Property defaults as field initializers; CronExpression[]
/// (Quartz) populated by the config loader via the CronExpressionTransformer (registered by Config's static ctor).</summary>
