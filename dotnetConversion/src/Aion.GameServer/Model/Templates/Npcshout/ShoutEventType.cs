...
/// <summary>Java parity: model/templates/npcshout/ShoutEventType (Rolandas).</summary>
[XmlType("ShoutEventType")]
...
public static class ShoutEventTypeExtensions
{
    // Java parity: value()
    public static string Value(this ShoutEventType type) => type.ToString();

    // Java parity: fromValue(String)
    public static ShoutEventType FromValue(string v) => (ShoutEventType)System.Enum.Parse(typeof(ShoutEventType), v);
}
