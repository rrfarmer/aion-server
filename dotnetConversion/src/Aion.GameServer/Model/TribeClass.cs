...
/// <summary>
/// NPC/creature tribe class identifiers. Used in AI aggro rules and XML data.
/// Java parity: model/TribeClass.
/// Note: member names intentionally use Java SCREAMING_SNAKE_CASE to preserve XML
/// data compatibility and string-based IsGuard() behavior (Java name().contains("GUARD")).
/// </summary>
...
/// <summary>
/// Extension methods mirroring TribeClass's Java instance methods.
/// Java parity: model/TribeClass::isGuard, model/TribeClass::isPC.
/// </summary>
public static class TribeClassExtensions
{
    // Java parity: TribeClass::isGuard() — name().toUpperCase().contains("GUARD")
    // Since C# enum member names are preserved as SCREAMING_SNAKE_CASE, ToString() returns the Java name.
    public static bool IsGuard(this TribeClass tribe) =>
        tribe.ToString().Contains("GUARD", StringComparison.Ordinal);

    // Java parity: TribeClass::isPC()
    public static bool IsPC(this TribeClass tribe) =>
        tribe == TribeClass.PC || tribe == TribeClass.PC_DARK;
}
