...
public class DropNpc
{
    ...
    private System.WeakReference<Aion.GameServer.Model.Team.TemporaryPlayerTeam<Aion.GameServer.Model.Team.TeamMember<Aion.GameServer.Model.GameObjects.Players.Player>>> lootingTeam;
    ...
    {
        Aion.GameServer.Model.Team.TemporaryPlayerTeam<Aion.GameServer.Model.Team.TeamMember<Aion.GameServer.Model.GameObjects.Players.Player>> team =
    ...
    public void SetLootingTeam(Aion.GameServer.Model.Team.TemporaryPlayerTeam<Aion.GameServer.Model.Team.TeamMember<Aion.GameServer.Model.GameObjects.Players.Player>> team)
    {
        lootingTeam = new System.WeakReference<Aion.GameServer.Model.Team.TemporaryPlayerTeam<Aion.GameServer.Model.Team.TeamMember<Aion.GameServer.Model.GameObjects.Players.Player>>>(team);
