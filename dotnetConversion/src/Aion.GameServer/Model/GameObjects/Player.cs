...
public sealed class Player
{
	...
	// Java parity: PrivateStore.getStoreMessage/setStoreMessage used by CM_PRIVATE_STORE_NAME and SM_PRIVATE_STORE_NAME.
	public string PrivateStoreMessage { get; set; } = string.Empty;
