...
public class _28035TrustInNoneButVerify : AbstractQuestHandler
{
    private const int TALK_NPC_ID = 801280; // Lundvarr
    private const int END_NPC_ID = 804927; // Bastan
    private const int QUEST_ITEM_ID = 182213484; // Tariksha's Letter

    public _28035TrustInNoneButVerify() : base(28035)
    {
    }
