...
/// @author Cheatkiller
/// </summary>
public class _51008NonHelpingHands : AbstractQuestHandler
{
    public _51008NonHelpingHands() : base(51008)
    {
    }
    ...
    public override bool OnAttackEvent(QuestEnv env)
    {
        ...
        if (qs != null && qs.GetStatus() == QuestStatus.START)
        {
            ...
            if (targetId == 219291)
            {
                ...
                if (!npc.IsSpawned())
                    return false;
                SpawnSearchResult searchResult = DataManager.SPAWNS_DATA.GetFirstSpawnByNpcId(npc.GetWorldId(), 831037);
