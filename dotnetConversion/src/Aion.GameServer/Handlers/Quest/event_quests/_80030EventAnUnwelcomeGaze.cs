...
namespace Aion.GameServer.Handlers.Quest
{
    ...
    /// @author Rolandas
    /// </summary>
    public class _80030EventAnUnwelcomeGaze : AbstractQuestHandler
    {
        public _80030EventAnUnwelcomeGaze() : base(80030)
        {
        }
        ...
        public override HandlerResult OnItemUseEvent(QuestEnv env, Item item)
        {
            ...
            if (item.GetItemTemplate().GetTemplateId() == 188051133 && player.GetCommonData().GetRace().Equals(Race.ELYOS))
            {
