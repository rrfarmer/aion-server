...
/// @author Estrayl
/// </summary>
public class _30772InvestigateTheGate : AbstractQuestHandler
{
    private const string ZONE_NAME = "RUINHOLD_SCATTERINGS_210070000";
    private const int START_NPC_ID = 804869; // Ginnie
    private const int END_NPC_ID = 804897; // Ajinos

    public _30772InvestigateTheGate() : base(30772)
    {
    }
