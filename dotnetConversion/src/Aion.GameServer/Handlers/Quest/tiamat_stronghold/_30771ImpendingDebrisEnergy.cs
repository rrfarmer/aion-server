...
/// @author Estrayl
/// </summary>
public class _30771ImpendingDebrisEnergy : AbstractQuestHandler
{
	private const int QUEST_ITEM_ID = 182215699; // Restorative
	private const int START_NPC_ID = 804728; // Engrid
	private const int TALK_NPC_1_ID = 804871; // Hank
	private const int TALK_NPC_2_ID = 804869; // Ginnie
	private const int ATTACKER_NPC_ID = 217424; // Mirror Image

	public _30771ImpendingDebrisEnergy() : base(30771)
	{
	}
