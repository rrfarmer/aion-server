...
/// @author Estrayl
/// </summary>
public class _30760PetrifiedHeroOfTheAsmodians : AbstractQuestHandler
{
    private const int QUEST_ITEM_ID = 182213268; // Marchutan's Protection
    private const int START_END_NPC_ID = 804871; // Hank
    private const int STATUE_NPC_ID = 701499; // Asmodian Hero's Statue

    public _30760PetrifiedHeroOfTheAsmodians() : base(30760)
    {
    }
