...
/// @author Pad
/// </summary>
public class _19642SuccessforSix : AbstractQuestHandler
{
    private static readonly int[] npcIds = { 798991, 798926 };
    private static readonly int[] mobIds = { 215650, 215651, 215652, 215653 };

    public _19642SuccessforSix() : base(19642)
    {
    }
