...
/// @author Pad
/// </summary>
public class _19631CoastalCrush : AbstractQuestHandler
{
    private static readonly int[] npcIds = { 798155, 800411 };
    private static readonly int[] mobIds = { 214216, 214217, 214198, 214199 };

    public _19631CoastalCrush() : base(19631)
    {
    }
