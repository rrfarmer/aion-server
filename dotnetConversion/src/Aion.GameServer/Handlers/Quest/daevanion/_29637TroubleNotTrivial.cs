...
/// @author Pad
/// </summary>
public class _29637TroubleNotTrivial : AbstractQuestHandler
{
    private static readonly int[] npcIds = { 799225, 799248 };
    private static readonly int[] mobIds = { 215879, 215880, 215937 };

    public _29637TroubleNotTrivial() : base(29637)
    {
    }
