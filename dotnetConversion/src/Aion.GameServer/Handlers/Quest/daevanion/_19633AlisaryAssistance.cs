...
/// @author Pad
/// </summary>
public class _19633AlisaryAssistance : AbstractQuestHandler
{
    private static readonly int[] npcIds = { 800411, 205304 };
    private static readonly int[] mobIds = { 214259, 214260, 214193 };

    public _19633AlisaryAssistance() : base(19633)
    {
    }
