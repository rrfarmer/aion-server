...
/// @author Pad
/// </summary>
public class _29641MoveAlongNow : AbstractQuestHandler
{
    private static readonly int[] npcIds = { 799248, 799297 };
    private static readonly int[] mobIds = { 216045, 216046, 215942 };

    public _29641MoveAlongNow() : base(29641)
    {
    }
