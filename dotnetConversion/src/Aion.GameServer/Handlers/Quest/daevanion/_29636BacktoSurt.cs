...
/// @author Pad
/// </summary>
public class _29636BacktoSurt : AbstractQuestHandler
{
    private static readonly int[] npcIds = { 205164, 205150 };
    private static readonly int[] mobIds = { 214491, 214492, 214489, 214490 };

    public _29636BacktoSurt() : base(29636)
    {
    }
