...
/// @author Pad
/// </summary>
public class _14220NewZoneNewRules : AbstractQuestHandler
{
    private const int startEndNpcId = 802540;
    private const int talkNpcId = 802541;
    ...
    public _14220NewZoneNewRules() : base(14220)
    {
    }
