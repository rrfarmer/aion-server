...
/// @author VladimirZ
/// </summary>
public class _2505LetCookingExpertsCook : AbstractQuestHandler
{
    private static readonly int[] npc_ids = { 204720, 204731 };

    public _2505LetCookingExpertsCook() : base(2505)
    {
    }
