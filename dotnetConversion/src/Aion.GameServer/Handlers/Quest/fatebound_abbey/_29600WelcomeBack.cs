...
public class _29600WelcomeBack : AbstractQuestHandler
{
    private const int npcId = 804662; // Melanka
    private const int itemId = 164000336; // Abbey Return Stone

    public _29600WelcomeBack() : base(29600)
    {
    }
