...
/// @author Ritsu, Pad
/// </summary>
public class _19057MasterConstructorsPotential : AbstractQuestHandler
{
    private static readonly int[] recipesItemIds = { 152203543, 152203544 };
    private static readonly int[] recipesIds = { 155003543, 155003544 };

    public _19057MasterConstructorsPotential() : base(19057)
    {
    }
