...
/// <summary>Java parity: quest/crafting/_2983ExpertTailorsFinalExam (Gigi, Pad).</summary>
public class _2983ExpertTailorsFinalExam : AbstractQuestHandler
{
    public _2983ExpertTailorsFinalExam() : base(2983)
    {
    }
