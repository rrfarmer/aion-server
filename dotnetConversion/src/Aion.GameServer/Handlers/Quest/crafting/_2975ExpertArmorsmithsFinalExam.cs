...
/// <summary>Java parity: quest/crafting/_2975ExpertArmorsmithsFinalExam (Gigi, Pad).</summary>
public class _2975ExpertArmorsmithsFinalExam : AbstractQuestHandler
{
    public _2975ExpertArmorsmithsFinalExam() : base(2975)
    {
    }
