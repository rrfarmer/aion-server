...
/// <summary>Java parity: quest/crafting/_2977ExpertHandicraftersFinalExam (Gigi, Pad).</summary>
public class _2977ExpertHandicraftersFinalExam : AbstractQuestHandler
{
    public _2977ExpertHandicraftersFinalExam() : base(2977)
    {
    }
