...
/// <summary>Java parity: quest/crafting/_1972ExpertPassionforWeaponsmithing (Gigi, Pad).</summary>
public class _1972ExpertPassionforWeaponsmithing : AbstractQuestHandler
{
    public _1972ExpertPassionforWeaponsmithing() : base(1972)
    {
    }
