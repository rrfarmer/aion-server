...
/// <summary>Java parity: quest/crafting/_1974ExpertPassionforArmorsmithing (Gigi, Pad).</summary>
public class _1974ExpertPassionforArmorsmithing : AbstractQuestHandler
{
    public _1974ExpertPassionforArmorsmithing() : base(1974)
    {
    }
