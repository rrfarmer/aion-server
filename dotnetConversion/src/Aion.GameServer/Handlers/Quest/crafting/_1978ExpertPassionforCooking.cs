...
/// <summary>Java parity: quest/crafting/_1978ExpertPassionforCooking (Gigi, Pad).</summary>
public class _1978ExpertPassionforCooking : AbstractQuestHandler
{
    public _1978ExpertPassionforCooking() : base(1978)
    {
    }
