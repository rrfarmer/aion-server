...
/// <summary>Java parity: quest/crafting/_2976ExpertHandicraftersTest (Gigi, Pad).</summary>
public class _2976ExpertHandicraftersTest : AbstractQuestHandler
{
    public _2976ExpertHandicraftersTest() : base(2976)
    {
    }
