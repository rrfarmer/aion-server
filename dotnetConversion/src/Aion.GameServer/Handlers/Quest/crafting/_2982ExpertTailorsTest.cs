...
/// <summary>Java parity: quest/crafting/_2982ExpertTailorsTest (Gigi, Pad).</summary>
public class _2982ExpertTailorsTest : AbstractQuestHandler
{
    public _2982ExpertTailorsTest() : base(2982)
    {
    }
