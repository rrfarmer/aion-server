...
/// <summary>Java parity: quest/crafting/_1982ExpertAPassionForTailoring (Gigi, Pad).</summary>
public class _1982ExpertAPassionForTailoring : AbstractQuestHandler
{
    public _1982ExpertAPassionForTailoring() : base(1982)
    {
    }
