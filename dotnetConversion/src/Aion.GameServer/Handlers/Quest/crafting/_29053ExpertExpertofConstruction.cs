...
/// <summary>Java parity: quest/crafting/_29053ExpertExpertofConstruction (Ritsu, Pad).</summary>
public class _29053ExpertExpertofConstruction : AbstractQuestHandler
{
    public _29053ExpertExpertofConstruction() : base(29053)
    {
    }
