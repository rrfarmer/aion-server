...
/// <summary>Java parity: quest/crafting/_1980ExpertPassionforAlchemy (Gigi, Pad).</summary>
public class _1980ExpertPassionforAlchemy : AbstractQuestHandler
{
    public _1980ExpertPassionforAlchemy() : base(1980)
    {
    }
