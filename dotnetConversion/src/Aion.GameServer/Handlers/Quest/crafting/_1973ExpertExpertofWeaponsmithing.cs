...
/// <summary>Java parity: quest/crafting/_1973ExpertExpertofWeaponsmithing (Gigi, Pad).</summary>
public class _1973ExpertExpertofWeaponsmithing : AbstractQuestHandler
{
    public _1973ExpertExpertofWeaponsmithing() : base(1973)
    {
    }
