...
/// <summary>Java parity: quest/crafting/_2978ExpertCooksTest (Gigi, Pad).</summary>
public class _2978ExpertCooksTest : AbstractQuestHandler
{
    public _2978ExpertCooksTest() : base(2978)
    {
    }
