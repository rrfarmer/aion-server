...
/// <summary>Java parity: quest/crafting/_1977ExpertExpertofHandicrafting (Gigi, Pad).</summary>
public class _1977ExpertExpertofHandicrafting : AbstractQuestHandler
{
    public _1977ExpertExpertofHandicrafting() : base(1977)
    {
    }
