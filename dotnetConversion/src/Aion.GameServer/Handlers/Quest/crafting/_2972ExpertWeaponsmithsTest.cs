...
/// <summary>Java parity: quest/crafting/_2972ExpertWeaponsmithsTest (Gigi, Pad).</summary>
public class _2972ExpertWeaponsmithsTest : AbstractQuestHandler
{
    public _2972ExpertWeaponsmithsTest() : base(2972)
    {
    }
