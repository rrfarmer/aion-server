...
/// <summary>Java parity: quest/crafting/_2980ExpertAlchemistsTest (Gigi, Pad).</summary>
public class _2980ExpertAlchemistsTest : AbstractQuestHandler
{
    public _2980ExpertAlchemistsTest() : base(2980)
    {
    }
