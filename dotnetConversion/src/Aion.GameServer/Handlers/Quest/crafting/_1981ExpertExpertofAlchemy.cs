...
/// <summary>Java parity: quest/crafting/_1981ExpertExpertofAlchemy (Gigi, Pad).</summary>
public class _1981ExpertExpertofAlchemy : AbstractQuestHandler
{
    public _1981ExpertExpertofAlchemy() : base(1981)
    {
    }
