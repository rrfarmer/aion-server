...
namespace Aion.GameServer.Handlers.Quest
{
    ...
    /// @author Gigi
    /// </summary>
    public class _30303GroupTheFallofIsbariya : AbstractQuestHandler
    {
        private static readonly int[] npc_ids = { 799225 };

        public _30303GroupTheFallofIsbariya() : base(30303)
        {
        }
