...
public class _16985ChirTreasureRobbers : AbstractQuestHandler
{
    private static readonly int[] npcIds = { 804864, 804862 };

    public _16985ChirTreasureRobbers() : base(16985)
    {
    }
