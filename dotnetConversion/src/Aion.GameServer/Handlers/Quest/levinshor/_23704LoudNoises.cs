...
/// @author Pad
/// </summary>
public class _23704LoudNoises : AbstractQuestHandler
{
    private static readonly int npcId = 802343; // Rink
    private static readonly int itemId = 182215533;

    public _23704LoudNoises() : base(23704)
    {
    }
