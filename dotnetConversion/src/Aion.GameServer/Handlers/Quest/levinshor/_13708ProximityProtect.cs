...
/// @author Pad
/// </summary>
public class _13708ProximityProtect : AbstractQuestHandler
{
    private static readonly int npcId = 802332; // Feleus
    private static readonly int itemId = 182215529;

    public _13708ProximityProtect() : base(13708)
    {
    }
