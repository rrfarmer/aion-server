...
/// @author Leunam
/// </summary>
public class _11455WhentheTimeisRipe : AbstractQuestHandler
{
    private static readonly int[] npc_ids = { 799070, 798933, 798946 };

    public _11455WhentheTimeisRipe() : base(11455)
    {
    }
