...
/// @author Leunam
/// </summary>
public class _11106RewritingHistory : AbstractQuestHandler
{
    private static readonly int[] npc_ids = { 798976, 798978, 798979, 203832 };

    public _11106RewritingHistory() : base(11106)
    {
    }
