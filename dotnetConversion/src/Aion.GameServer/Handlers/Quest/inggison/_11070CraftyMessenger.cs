...
namespace Aion.GameServer.Handlers.Quest
{
    ...
    /// @author Leunam
    /// </summary>
    public class _11070CraftyMessenger : AbstractQuestHandler
    {
        private static readonly int[] npc_ids = { 798945, 798943, 798949, 798932 };

        public _11070CraftyMessenger() : base(11070)
        {
        }
