...
/// @author Leunam
/// </summary>
public class _11116MunchingMookiePickles : AbstractQuestHandler
{
    private static readonly int[] npc_ids = { 798986, 798964, 203784, 203785 };

    public _11116MunchingMookiePickles() : base(11116)
    {
    }
