...
///
/// @author Ritsu, Estrayl. Java parity: instance/ShugoImperialTombInstance : GeneralInstanceHandler. @InstanceID(300560000). 1:1.
/// </summary>
[InstanceID(300560000)]
public class ShugoImperialTombInstance : GeneralInstanceHandler
{
    private readonly List<ScheduledTask> spawnTasks = new();
    private int stage; // AtomicInteger

    public ShugoImperialTombInstance(WorldMapInstance instance) : base(instance)
    {
    }
    ...
    {
        int skillId = Volatile.Read(ref stage) switch
        {
            3 => player.GetRace() == Race.ASMODIANS ? 21105 : 21096,
            2 => player.GetRace() == Race.ASMODIANS ? 21104 : 21095,
            _ => player.GetRace() == Race.ASMODIANS ? 21103 : 21094,
        };
        ThreadPoolManager.GetInstance().Schedule(() => Aion.GameServer.SkillEngine.SkillEngine.GetInstance().ApplyEffectDirectly(skillId, player, player), 1000);
    }
    ...
    public override void OnChangeStageList(StageList list)
    {
        switch (list)
        {
            case StageList.START_STAGE_1_PHASE_1:
                ...
                // Bonus Wave 1
                spawnTasks.Add(ThreadPoolManager.GetInstance().Schedule(StartBonusStage1, 35000));
                ...
                break;
            case StageList.START_STAGE_1_PHASE_2:
                ...
                break;
            case StageList.START_STAGE_2_PHASE_1:
                if (Interlocked.CompareExchange(ref stage, 2, 1) != 1)
                    return;
                // Defense towers
                ...
                break;
            case StageList.START_STAGE_2_PHASE_2:
                ...
                break;
            case StageList.START_STAGE_3_PHASE_1:
                if (Interlocked.CompareExchange(ref stage, 3, 2) != 2)
                    return;
                // Defense towers
                ...
                // Bonus spawn wave 1
                spawnTasks.Add(ThreadPoolManager.GetInstance().Schedule(StartBonusStage3, 38000));
                ...
                break;
            case StageList.START_STAGE_3_PHASE_2:
    ...
    private void HandleBossSpawn(StageList stageList)
    {
        switch (stageList)
        {
            case StageList.START_STAGE_1_PHASE_1:
                ...
                {
                    case 0: Sp(219514, 205.88284f, 287.48337f, 550.68805f, "3005600006"); break; // Left
                    case 1: Sp(219514, 220.89374f, 275.24585f, 550.68805f, "3005600011"); break; // Right
                }
                break;
            case StageList.START_STAGE_1_PHASE_2:
                switch (Rnd.NextInt(2))
                {
                    case 0: Sp(219515, 204.04073f, 284.8664f, 550.68805f, "3005600008"); break; // Left
                    case 1: Sp(219515, 219.07242f, 273.14923f, 550.68805f, "3005600013"); break; // Right
                }
                break;
            case StageList.START_STAGE_2_PHASE_1:
                switch (Rnd.NextInt(3))
                {
                    case 0: Sp(219522, 308.5412f, 420.81482f, 296.40808f, "3005600026"); break; // Left
                    case 1: Sp(219522, 316.7461f, 433.27048f, 294.58875f, "3005600036"); break; // Mid
                    case 2: Sp(219522, 314.70178f, 444.68613f, 296.40808f, "3005600041"); break; // Right
                }
                break;
            case StageList.START_STAGE_2_PHASE_2:
                switch (Rnd.NextInt(3))
                {
                    case 0: Sp(219523, 308.5412f, 420.81482f, 296.40808f, "3005600026"); break; // Left
                    case 1: Sp(219523, 316.14932f, 430.78998f, 294.58875f, "3005600031"); break; // Mid
                    case 2: Sp(219523, 314.70178f, 444.68613f, 296.40808f, "3005600041"); break; // Right
                }
                break;
            case StageList.START_STAGE_3_PHASE_1:
                switch (Rnd.NextInt(3))
                {
                    case 0: Sp(219530, 412.90878f, 60.187855f, 222.409f, "3005600056"); break; // Left
                    case 1: Sp(219530, 423.48468f, 94.36587f, 214.3483f, "30056000060-B"); break; // Mid
                    case 2: Sp(219530, 390.72717f, 108.61628f, 222.40979f, "3005600066"); break; // Right
                }
                break;
            case StageList.START_STAGE_3_PHASE_2:
                switch (Rnd.NextInt(3))
                {
                    case 0: Sp(219531, 409.00763f, 58.69102f, 222.41164f, "3005600054"); break; // Left
                    case 1: Sp(219531, 420.5633f, 90.57509f, 214.33856f, "3005600057"); break; // Mid
                    case 2: Sp(219531, 388.09738f, 104.93561f, 222.41173f, "3005600061"); break; // Right
                }
                break;
        }
    }
    ...
    private void Sp(int npcId, float x, float y, float z, string walkerId, bool isRun)
    {
