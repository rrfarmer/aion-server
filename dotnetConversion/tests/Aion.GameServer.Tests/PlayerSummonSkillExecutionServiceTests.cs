...
public class PlayerSummonSkillExecutionServiceTests
{
	...
	[Fact]
	public void ProjectMercenaryNpcSkillAttackCycleResultContract_EnumeratesFutureLiveSideEffects()
	{
		var service = new PlayerSummonSkillExecutionService();
		var knownObject = new PlayerSummonKnownObject(8014, PlayerSummonKnownObjectKind.Creature);
		var currentTarget = new PlayerSummonKnownObject(9014, PlayerSummonKnownObjectKind.Creature);
		var candidate = new PlayerSummonKnownObjectNpcSkillCandidateMetadata(
			0,
			new PlayerSummonKnownObjectNpcSkillTemplateMetadata(Priority: 9));
		var listProjection = service.ProjectMercenaryNpcSkillCandidateList(
		...
		var readyCycle = PlayerSummonKnownObjectNpcSkillAttackCycleSnapshot.Captured(
			...
			performAttackExecutionPreview,
			schedulerCallbackOutcome);
		var readyInvocation = service.ProjectMercenaryNpcSkillAttackCycleLiveInvocation(readyCycle);
		var blockedInvocation = service.ProjectMercenaryNpcSkillAttackCycleLiveInvocation(
			service.ProjectMercenaryNpcSkillAttackCycle(knownObject));
		...
		Assert.Same(readyInvocation, contract.LiveInvocation);
		Assert.Equal([
			PlayerSummonKnownObjectNpcSkillAttackCycleExpectedSideEffect.AiCastSubState,
			PlayerSummonKnownObjectNpcSkillAttackCycleExpectedSideEffect.SchedulerSkillActionCallback,
			PlayerSummonKnownObjectNpcSkillAttackCycleExpectedSideEffect.ControllerUseSkill,
			PlayerSummonKnownObjectNpcSkillAttackCycleExpectedSideEffect.SkillEffectApplication,
		...
		Assert.Equal([
			...
			PlayerSummonKnownObjectNpcSkillAttackCycleLiveOperation.CreatureControllerUseSkill,
			PlayerSummonKnownObjectNpcSkillAttackCycleLiveOperation.PostSpawnSchedule,
			PlayerSummonKnownObjectNpcSkillAttackCycleLiveOperation.SkillEffectApplication,
			PlayerSummonKnownObjectNpcSkillAttackCycleLiveOperation.PacketFanout,
		], contract.FutureLiveAdapterOperations);
		...
		Assert.True(contract.HasLiveOperation(PlayerSummonKnownObjectNpcSkillAttackCycleLiveOperation.ThreadPoolScheduleSkillAction));
		Assert.True(contract.HasLiveOperation(PlayerSummonKnownObjectNpcSkillAttackCycleLiveOperation.CreatureControllerUseSkill));
	...
	public void ProjectMercenaryNpcSkillAttackCycleResultContract_LabelsFailureOutcomeBranches()
	{
		...
		Assert.Contains(PlayerSummonKnownObjectNpcSkillAttackCycleLiveOperation.ControllerAbortCast, preActionTooFar.FutureLiveAdapterOperations);
		Assert.Contains(PlayerSummonKnownObjectNpcSkillAttackCycleLiveOperation.NpcAiOnTargetTooFar, preActionTooFar.FutureLiveAdapterOperations);
		...
		Assert.Contains(PlayerSummonKnownObjectNpcSkillAttackCycleLiveOperation.NpcAiSetNoneSubState, targetGiveUp.FutureLiveAdapterOperations);
		Assert.Contains(PlayerSummonKnownObjectNpcSkillAttackCycleLiveOperation.NpcAiOnTargetGiveUp, targetGiveUp.FutureLiveAdapterOperations);
		...
		Assert.Contains(PlayerSummonKnownObjectNpcSkillAttackCycleLiveOperation.ControllerAbortCast, skillActionTargetTooFar.FutureLiveAdapterOperations);
		Assert.Contains(PlayerSummonKnownObjectNpcSkillAttackCycleLiveOperation.NpcAiOnTargetTooFar, skillActionTargetTooFar.FutureLiveAdapterOperations);
		...
		Assert.Contains(PlayerSummonKnownObjectNpcSkillAttackCycleLiveOperation.NpcAiSetNoneSubState, blocked.FutureLiveAdapterOperations);
		Assert.Contains(PlayerSummonKnownObjectNpcSkillAttackCycleLiveOperation.NpcAiOnAttackComplete, blocked.FutureLiveAdapterOperations);
		...
		Assert.Contains(PlayerSummonKnownObjectNpcSkillAttackCycleLiveOperation.CreatureControllerUseSkill, failedUse.FutureLiveAdapterOperations);
		Assert.Contains(PlayerSummonKnownObjectNpcSkillAttackCycleLiveOperation.NpcAiOnAttackComplete, failedUse.FutureLiveAdapterOperations);
	...
	public void ProjectMercenaryNpcSkillItemUsageStateTrace_MapsPositiveTimeUsingItemTiming()
	{
		...
		Assert.Contains(
			...
			path => path.Kind == PlayerSummonKnownObjectNpcSkillItemUsageStatePathKind.AnimationAdd
				...
				&& path.CancelEndState == 3);
		Assert.Contains(
			trace.CSharpPositiveTimePaths,
			path => path.Kind == PlayerSummonKnownObjectNpcSkillItemUsageStatePathKind.ExpExtract
				&& path.SendKind == PlayerSummonKnownObjectNpcSkillItemUsageStateSendKind.SendSelfOnly
				&& path.StartTimeMilliseconds == 5000
